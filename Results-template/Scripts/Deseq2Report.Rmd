...
deseq2out=read.table(paste("DESeq2_deg_",contras[i],"_vs_",contras[i+1],".txt",sep=""),header = TRUE)
...
write.table(deseq2out,file=paste("DESeq2_deg_",contras[i],"_vs_",contras[i+1],".txt",sep=""),row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")
...
if ((grepl("hg",SPECIES)||grepl("mm",SPECIES))&&(grepl("genes",params$dtype)))
{
system(paste0("cd ",getwd(),"; python ../Scripts/FC2karyo.py DESeq2_deg_",contras[i],"_vs_",contras[i+1],".txt 1 3 ",SPECIES," ",KARYOBEDS," > DESeq2_deg_",contras[i],"_vs_",contras[i+1],".input.karyo"))
