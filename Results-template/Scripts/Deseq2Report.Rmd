...
#if ((grepl("hg",SPECIES)||grepl("mm",SPECIES))&&(params$dtype=="genes"||params$dtype=="genes"))
#{
...
if ((grepl("hg",SPECIES)||grepl("mm",SPECIES))&&(params$dtype=="genes"||params$dtype=="genes"))
{
system(paste0("cd ",getwd(),"; python ../Scripts/FC2karyo.py DESeq2_deg_",cons[i],"_all_genes.txt 2 4 ",SPECIES," > DESeq2_deg_",cons[i],".input.karyo"))
system(paste0("cd ",getwd(),"; python ../Scripts/karyoplot.py DESeq2_deg_",cons[i],".input.karyo ",SPECIES))
ki1=paste0("DESeq2_deg_",cons[i],".input.karyo1.png")
ki2=paste0("DESeq2_deg_",cons[i],".input.karyo2.png")
cat("\n###KARYO PLOT",cons[i],"\n")
cat("![](",ki1,")")
#kp1[[i]]<-knitr::include_graphics(paste0("DESeq2_deg_",cons[i],".input.karyo1.png"))
cat("\n")
cat("![](",ki2,")")
#kp2[[i]]<-knitr::include_graphics(paste0("DESeq2_deg_",cons[i],".input.karyo2.png"))
cat("\n\n")
}
