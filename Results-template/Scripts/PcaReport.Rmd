...
```{r, echo=FALSE,message=FALSE,fig.show='hold',fig.align='center', warning=FALSE, fig.width=500, fig.height=hmapheight}
...
```{r, echo=FALSE,message=FALSE,fig.show='hold',fig.align='center', warning=FALSE, fig.width=200, fig.height=3.3*length(sampleinfo$label)}
