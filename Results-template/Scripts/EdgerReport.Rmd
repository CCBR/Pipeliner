...
if ((grepl("hg",SPECIES)||grepl("mm",SPECIES))&&(params$dtype=="genes"||params$dtype=="genes"))
{
system(paste0("cd ",getwd(),"; python ../Scripts/FC2karyo.py EdgeR_deg_",cons[i],"_all_genes.txt 2 3 ",SPECIES," > EdgeR_deg_",cons[i],".input.karyo"))
...
cat("\n###KARYO PLOT",cons[i],"\n")
cat("![](",ki1,")")
#kp1[[i]]<-knitr::include_graphics(paste0("EdgeR_deg_",cons[i],".input.karyo1.png"))
cat("\n")
cat("![](",ki2,")")
#kp2[[i]]<-knitr::include_graphics(paste0("EdgeR_deg_",cons[i],".input.karyo2.png"))
cat("\n\n")
}
