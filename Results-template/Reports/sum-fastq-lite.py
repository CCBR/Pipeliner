        ...
        for aKey in keys:
            ...
            if summary_dict[aKey] == "PASS":
                ...
                for grep_search_term in basic_stats[3:]:
                                        ...
                                        result = grep_result.communicate()[0]
                                        result=repr(result)
...
def main():
    try:
        ...
        print("Using search suffix {0}, search directory {1}, and reports directory {2}.".format(SEARCH_SUFFIX_FILE_NAME,SEARCH_DIR,AGGREGATE_REPORTS_DIR))
