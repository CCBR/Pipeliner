rule cnvkit_summary_tumoronly:
    ...
    shell: "module load cnvkit/0.9.1; cnvkit.py heatmap -d -o {output.heatmap} cnvkit_out/*.cns; module load R/3.5; Rscript Scripts/cnplot.R cnvkit_out; cd cnvkit_out; perl ../Scripts/summarize_CNVs.pl"