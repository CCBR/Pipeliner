...
if config['project']['DEG'] == "yes" and config['project']['TRIM'] == "yes":
  rule all:
     ...
     input: "STAR_QC","Reports/multiqc_report.html",
            ...
            "postTrimQC",expand("TrimFQscreen/{name}_R1_001_trim_paired_screen.txt",name=samples)
  ...
  rule all:
     input: "STAR_QC","Reports/multiqc_report.html",
            expand("{name}.RnaSeqMetrics.txt",name=samples),"rawQC",expand("FQscreen/{name}.R1_screen.txt",name=samples)
     params: batch='--time=168:00:00'
...
#            """
   rule trimfastq_screen:
      input:  expand("trim/{name}_R1_001_trim_paired.fastq.gz", name=samples), expand("trim/{name}_R2_001_trim_paired.fastq.gz", name=samples) 
      output: "TrimFQscreen/{name}_R1_001_trim_paired_screen.txt",
            "TrimFQscreen/{name}_R1_001_trim_paired_screen.png",
            "TrimFQscreen/{name}_R1_001_trim_paired_screen.txt",
            "TrimFQscreen/{name}_R1_001_trim_paired_screen.png"
