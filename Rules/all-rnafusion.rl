...
#           "expression/RawCountFileStar.txt",
    ...
    params: rname="final"
    shell:  """
             module load python/2.7; Scripts/fusionSummary.sh; module load multiqc/1.3; multiqc -f .; rm *featureCounts; mv *.out slurmfiles/; perl Scripts/summarize_usage.pl
...
#           "expression/RawCountFileStar.txt",
    ...
    params: rname="final"
    shell:  """
             module load python/2.7; Scripts/fusionSummary.sh; module load multiqc/1.3; multiqc -f .; mv *.out slurmfiles/; perl Scripts/summarize_usage.pl
