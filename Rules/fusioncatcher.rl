rule fusioncatcher:
     ...
     threads: 16
     shell: "module load fusioncatcher/0.99.7b; mkdir -p fusioncatcher/{params.sample}; fusioncatcher -i {input.file1},{input.file2} -o fusioncatcher/{params.sample} --threads {threads}"