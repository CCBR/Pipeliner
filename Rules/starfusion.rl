rule starfusion:
     ...
     shell: "module load STAR/2.5.2b; mkdir -p starfusion/{params.sample}; STAR-Fusion --genome_lib_dir {params.starlib} --left-fq {input.file1} --right-fq {input.file2} --output_dir starfusion/{params.sample}"