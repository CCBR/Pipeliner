rule cnvkit_germ:
    ...
    shell: "module load cnvkit/0.8.5; cnvkit.py batch *.recal.bam -n -c --split --fasta {params.genome} --targets {params.targets} --antitargets {params.antitargets} --output-reference cnvkit/flatref.cnn --output-dir cnvkit/ --diagram; cnvkit.py heatmap cnvkit/*.cns -d -o cnvkit/germline_cnvkit.heatmap"