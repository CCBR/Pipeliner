rule qualimap_wgs:
    ...
    shell:  "{params.qualimap} bamqc --java-mem-size=96G -bam {input} -c gd {params.organism} -outdir {output} -ip --skip-duplicated -nt {threads} -outformat HTML -nw 500 -p NON-STRAND-SPECIFIC"