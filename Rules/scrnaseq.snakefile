...
rule scrna_initial: 
   ...
   shell: "cp Scripts/scrna_initial.Rmd {params.dir}/; module load R/3.5; Rscript Scripts/scrna_initial_call.R '{params.dir}' '{params.countspath}/{params.refer}' '{params.refer}' '{params.projectId}' '{params.projDesc}'"
...
rule scrna_jackstraw: 
   ...
   shell: "cp Scripts/scrna_jackstraw.Rmd {params.dir}/; module load R/3.5; Rscript Scripts/scrna_jackstraw_call.R '{params.dir}' '{input.so}' '{params.projectId}' '{params.projDesc}'"
...
rule scrna_cluster: 
   ...
   shell: "cp Scripts/scrna_cluster.Rmd {params.dir}/; module load R/3.5; Rscript Scripts/scrna_cluster_call.R '{params.dir}' '{input.so}' '{params.pcs}' '{params.resolution}' '{params.projectId}' '{params.projDesc}'"