...
rule scrna_initial: 
   ...
   shell: "cp Scripts/scrna_initial.Rmd {params.dir}/; module load R/3.4.0_gcc-6.2.0; Rscript Scripts/scrna_initial_call.R '{params.dir}' '{params.countspath}' '{params.refer}' '{params.projectId}' '{params.projDesc}'"
