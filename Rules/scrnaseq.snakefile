...
rule scrna_initial: 
   params: rname='pl:scrnainit',batch='--cpus-per-task=32 --mem=246g --time=48:00:00',countspath=config['project']['COUNTSPATH'],refer=config['project']['annotation'],dir=config['project']['workpath'],projDesc=config['project']['description'],projectId=config['project']['id']
...
rule scrna_jackstraw: 
   params: rname='pl:scrnajackstraw',batch='--cpus-per-task=32 --mem=246g --time=48:00:00',dir=config['project']['workpath'],projDesc=config['project']['description'],projectId=config['project']['id']
...
rule scrna_cluster: 
   params: rname='pl:scrnacluster',batch='--cpus-per-task=32 --mem=246g --time=48:00:00',dir=config['project']['workpath'],pcs=config['project']['PCS'],resolution=config['project']['RESOLUTION'],projDesc=config['project']['description'],projectId=config['project']['id']
   input: so="{projectId}_seurat_object.rds".format(projectId=config['project']['id'])
