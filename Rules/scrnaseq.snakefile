...
rule scrna_initial: 
   ...
   shell: "cp Scripts/scrna_initial_call.R {params.dir}/; module load R/3.4.0_gcc-6.2.0; Rscript Scripts/scrna_initial_call.R '{params.dir}' '{params.refer}' '{params.projectId}' '{params.projDesc}'"
...
rule scrna_jackstraw: 
   ...
   shell: "cp Scripts/scrna_jackstraw_call.R {params.dir}/; module load R/3.4.0_gcc-6.2.0; Rscript Scripts/scrna_jackstraw_call.R '{params.dir}' '{input.so}' '{params.projectId}' '{params.projDesc}'"
...
rule scrna_cluster: 
   ...
   shell: "cp Scripts/scrna_cluster_call.R {params.dir}/; module load R/3.4.0_gcc-6.2.0; Rscript Scripts/scrna_cluster_call.R '{params.dir}' '{input.so}' '{params.pcs}' '{params.resolution}' '{params.projectId}' '{params.projDesc}'"