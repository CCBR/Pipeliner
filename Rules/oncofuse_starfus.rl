rule rule oncofuse_starfus:
     ...
     shell: "mkdir -p starfusion/oncofuse/{params.sample}; perl Scripts/make_oncofuse_input.pl {params.sample} starfusion; {params.oncofuse} -p 1 -a {params.build} {output.infile} coord - {output.outfile}"