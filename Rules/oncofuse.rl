rule oncofuse:
     ...
     shell: "mkdir -p oncofuse/{params.sample}; perl Scripts/make_oncofuse_input.pl {params.sample} .; {params.oncofuse} -p 1 -a {params.build} {output.infile} coord - {output.outfile}"