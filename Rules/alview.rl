rule alview:
      ...
      shell:  "perl Scripts/run_alview.pl {input.mutect} {params.genome} mutect_out/oncotator_out/ mutect {params.workdir}; perl Scripts/run_alview.pl {input.strelka} {params.genome} strelka_out/oncotator_out/ strelka {params.workdir}; perl Scripts/run_alview.pl {input.mutect2} {params.genome} mutect2_out/oncotator_out/ mutect2 {params.workdir}; cd /data/CCBR_Pipeliner/db/PipeDB/bin/ALVIEW; ./alvgenslideshow {params.workdir}/mutect_variants_images {params.workdir}/{output.mutect} {params.genome}; ./alvgenslideshow {params.workdir}/strelka_variants_images {params.workdir}/{output.strelka} {params.genome}; ./alvgenslideshow {params.workdir}/mutect2_variants_images {params.workdir}/{output.mutect2} {params.genome}"