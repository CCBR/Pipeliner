rule delly_somatic_del:
    ...
    shell: "module load delly/0.7.7; delly call -t DEL -x {params.exclusions} -o {output.deletion} -g {params.genome} {input.tumor} {input.normal}; module load samtools; bcftools convert -O v -o {output.delvcf} {output.deletion}"
...
rule delly_somatic_ins:
    ...
    shell: "module load delly/0.7.7; delly call -t INS -x {params.exclusions} -o {output.ins} -g {params.genome} {input.tumor} {input.normal}; module load samtools; bcftools convert -O v -o {output.insvcf} {output.ins}"
...
rule delly_somatic_dup:
    ...
    shell: "module load delly/0.7.7; delly call -t DUP -x {params.exclusions} -o {output.dup} -g {params.genome} {input.tumor} {input.normal}; module load samtools; bcftools convert -O v -o {output.dupvcf} {output.dup}"
...
rule delly_somatic_trans:
    ...
    shell: "module load delly/0.7.7; delly call -t BND -x {params.exclusions} -o {output.tra} -g {params.genome} {input.tumor} {input.normal}; module load samtools; bcftools convert -O v -o {output.transvcf} {output.tra}"
...
rule delly_somatic_inv:
    ...
    shell: "module load delly/0.7.7; delly call -t INV -x {params.exclusions} -o {output.inv} -g {params.genome} {input.tumor} {input.normal}; module load samtools; bcftools convert -O v -o {output.invvcf} {output.inv}"