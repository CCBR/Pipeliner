rule rnafusioncleanup:
        ...
        shell:  "rm *.star_rg_added.sorted.dmark.bai; mv *.star.duplic expression/; mv *.star.count.info.overlap.txt.summary expression/; mv *.star.count.info.txt.summary expression/; mv *.star.count.info.overlap.txt expression/; mv *.star.count.txt expression/; mv *.star.count.info.txt expression/; mv HistBeforenormFilter.png expression/; mv RawCount_genes_unfiltered.txt expression/; mv *_counts.txt expression/; mv *.InsertSizeMetrics.txt expression/; mv *.InsertSizeHisto.pdf expression/; mv *.flagstat.concord.txt expression/; mv *filtered.tx expression/; mv *.RnaSeqMetrics.txt expression/; mv *.star.count.overlap.txt expression/; mv RawCountFileOverlap.txt expression/; mv RawCountFileStar.txt expression/; mv *.rsem.genes.results expression/"