if config['project']['annotation'] == "hg19":
  rule gatk_merge_mutect2_chrom:
    ...
    params: tumorsample=lambda wildcards: config['project']['units'][wildcards.x],dir=config['project']['workpath'],gatk=config['bin'][pfamily]['GATK'],genome=config['references'][pfamily]['GENOME'],snpeff=config['bin'][pfamily]['SNPEFF'],snpeffgenome=config['references'][pfamily]['SNPEFF_GENOME'],effconfig=config['references'][pfamily]['SNPEFF_CONFIG'],rname="pl:merge.mutect2"
