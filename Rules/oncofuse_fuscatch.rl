rule oncofuse_fuscatch:
     ...
     shell: "mkdir -p fusioncatcher/oncofuse/{params.sample}; perl Scripts/make_oncofuse_input.pl {params.sample} fusioncatcher; {params.oncofuse} -p 1 -a {params.build} {output.infile} coord - {output.outfile}"