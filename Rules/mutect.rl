rule mutect:
       ...
       output: vcf="mutect_out/{x}.vcf",
               ...
               snpeffvcf="mutect_out/{x}.snpeff.vcf",
               csvstats="mutect_out/{x}.stats.csv",
               htmlstats="mutect_out/{x}.stats.html"
