rule cnvkit_somatic:
    ...
    shell: "module load cnvkit/0.8; cnvkit.py batch -n {input.normal} --fasta {params.genome} --targets {params.targets} --antitargets {params.antitargets} --output-reference cnvkit_out/{params.normalsample}.reference.cnn --output-dir cnvkit_out {input.tumor}; cnvkit.py call -o {output.calls} cnvkit_out/{params.tumorsample}.cnr; cnvkit.py gainloss -s cnvkit_out/{params.tumorsample}.cns --drop-low-coverage -o {output.gainloss} cnvkit_out/{params.tumorsample}.cnr"