if config['project']['annotation'] == "hg19":
  ...
  rule gatk_rnaseqvar_haplotype_caller_1:
  ...
  rule gatk_rnaseqvar_haplotype_caller_3:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_4:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_5:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_6:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_7:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_8:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_9:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_10:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_11:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_12:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_13:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_14:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_15:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_16:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_17:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_18:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_19:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_20:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_21:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_22:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_X:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_Y:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
  ...
  rule gatk_rnaseqvar_haplotype_caller_MT:
     input: lambda wildcards: config['project']['units'][wildcards.x]+".recal.bam"
