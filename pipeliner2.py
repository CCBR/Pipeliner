...
class PipelinerGUI(Tk):
    ...
    def init_project_frame( self ) :
        ...
        annotations=['hg19','mm10','mm9','hg38','hs37d5','hs38d1','GRCh38','hg19_KSHV','canFam3','Mmul_8.0.1']
    ...
    def set_pipeline( self, *args ) :
        ...
        set1=['Select the genome','hg19','mm10','mm9','hg38','hs37d5','hs38d1','hg19_KSHV','canFam3','Mmul_8.0.1']
