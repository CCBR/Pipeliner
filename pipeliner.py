...
runmenu.add_command(label="Dry Run", command=lambda: cmd("--dryrun -p -s %s/Snakefile --rerun-incomplete -d %s" % (workpath.get(),workpath.get())))               
...
button = Button(runframe, text="Perform Dry Run", fg=widgetFgColor,bg=widgetBgColor,command=lambda: cmd("--dryrun -p -s %s/Snakefile --rerun-incomplete -d %s" % (workpath.get(),workpath.get())))
...
L2=Label(projpanel1,text="(Examples: CCBR-nnn,Labname or short project name)",anchor="ne",bg="firebrick",fg="white")
L2.grid(row=0,column=3,padx=10,pady=10,sticky="w")


L=Label(projpanel1,text="Email address",anchor="ne",bg=baseColor,fg=textLightColor)
E = Entry(projpanel1, bd =2, width=20, bg=entryBgColor, fg=entryFgColor,textvariable=euser)
L3=Label(projpanel1,text="(Mandatory field: must use @nih.gov email address)",anchor="ne",bg="firebrick",fg="white")
L3.grid(row=1,column=3,padx=10,pady=10,sticky="w")
#L.pack(pady=5,padx=5)
#E.pack(pady=1,padx=5)
...
L=Label(projpanel1,text="Flow Cell ID",anchor="ne",bg=baseColor,fg=textLightColor)
E = Entry(projpanel1, bd =2, width=20, bg=entryBgColor, fg=entryFgColor,textvariable=eflowcell)
L4=Label(projpanel1,text="(Examples: FlowCellID, Labname, date or short project name)",anchor="ne",bg="firebrick",fg="white")
L4.grid(row=2,column=3,padx=10,pady=10,sticky="w")
#L.pack(pady=5,padx=5)
#E.pack(pady=1,padx=5)
...
#L=Label(projpanel1,text="NIH email",anchor="ne",bg=baseColor,fg=textLightColor)
#E = Entry(projpanel1, bd =2, width=40, bg=entryBgColor, fg=entryFgColor,textvariable=eanalyst)
#L.pack(pady=5,padx=5)
#E.pack(pady=1,padx=5)
