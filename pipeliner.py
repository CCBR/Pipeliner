...
L2=Label(projpanel1,text="(Mandatory field. Examples: CCBR-nnn,Labname or short project name)",anchor="ne",bg="firebrick",fg="white")
...
L3=Label(projpanel1,text="(Mandatory field)",anchor="ne",bg="firebrick",fg="white")
...
L4=Label(projpanel1,text="(Mandatory field. Examples: FlowCellID, Labname, date or short project name)",anchor="ne",bg="firebrick",fg="white")
